...
function build_and_push_images() {
  docker build -t "maocorte/portainer:$1-${VERSION}" -f build/linux/Dockerfile .
  docker tag  "maocorte/portainer:$1-${VERSION}" "maocorte/portainer:$1"
  docker push "maocorte/portainer:$1-${VERSION}"
  docker push "maocorte/portainer:$1"
}
